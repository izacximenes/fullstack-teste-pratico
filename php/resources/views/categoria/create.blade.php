...
<div>
    ...
    <div class=" p-4 px-4 md:p-8 mb-6">
        <h2 class="font-bold text-xl py-2">Criar Categoria</h2>
        ...
        <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
            ...
            <form action="{{ route('categorias.store') }}" class="lg:col-span-2" method="POST">
                @csrf
                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                    <div class="md:col-span-5">
                        <label for="nome_categoria">Nome</label>
                        <input type="text" required name="nome_categoria" maxlength="150" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="" />
                    </div>
